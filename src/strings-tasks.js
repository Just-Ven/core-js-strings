...
function formatTime(minutes, seconds) {
  ...
  const result = formattedMinutes.concat(':', formattedSeconds);
  return result;
}
...
function isPalindrome(str) {
  ...
  // Проверка на палиндром с использованием методов массива
...
function encodeToRot13(str) {
  return str.replace(/[a-zA-Z]/g, function replaceChar(char) {
    const shift = char.charCodeAt(0) <= 90 ? 65 : 97;
